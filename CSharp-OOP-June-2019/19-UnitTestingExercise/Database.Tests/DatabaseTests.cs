...
namespace Tests
{
    public class DatabaseTests
    {
        ...
        [Test]
        public void CanNotUseAddOperationWhenDatabaseIsFull()
        {
            // Act
        ...
        {
            // Arrange
            this.database = new Database.Database(firstNumber, secondNumber);
        ...
        public void CanNotInitializeDatabaseWithCollectionContainingMoreThanItsCapacity()
        {
            ...
            // Assert
            Assert.Throws<InvalidOperationException>(() => this.database = new Database.Database(testCollection));
        }
